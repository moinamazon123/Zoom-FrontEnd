...
@Component({
  selector: "app-student-incompletedclass",
  templateUrl: "./student-incompletedclass.component.html",
  styleUrls: ["./student-incompletedclass.component.scss"]
})
export class StudentIncompletedclassComponent implements OnInit {
  ...
  ngOnInit() {
    // console.log(this.Incompletechild)
